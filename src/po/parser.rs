use super::{line::PoLine, file::PoFile, unescape::Unescaper};
...
///
/// The reader is created by the method `[PoBuilder::parse](#method.parse)`.
pub struct PoParser {
    map_re:       Regex,
    map_check_re: Regex,
    message_re:   Regex,
...
impl PoParser {
    ...
    pub fn parse<R: Read>(&self, reader: R) -> Result<PoFile<R>, Error> {
        PoFile::new(reader, self)
    }
